...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'Houston13':
        # Load the image
        Houston13_data = h5py.File(os.path.join(folder, 'Houston13.mat'), 'r')
        img = np.transpose(Houston13_data['ori_data'])

        Houston13_7gt_data = h5py.File(os.path.join(folder, 'Houston13_7gt.mat'), 'r')
        ...
        Houston18_data = h5py.File(os.path.join(folder, 'Houston18.mat'), 'r')
        img = np.transpose(Houston18_data['ori_data'])

        Houston18_7gt_data = h5py.File(os.path.join(folder, 'Houston18_7gt.mat'), 'r')
        ...
        # HyRANK 源域 (IEEE GRSS Data Fusion Contest / HyRANK benchmark)
        img = open_file(os.path.join(folder, 'Dioni.mat'))['ori_data']

        gt = open_file(os.path.join(folder, 'Dioni_7gt.mat'))['map']

        label_values = ["mineral extraction sites", "non-irrigated arable land",
                        "broad-leaved forest", "coniferous forest",
                        "mixed forest", "sclerophyllous vegetation",
        ...
        gt = open_file(os.path.join(folder, 'Loukia_7gt.mat'))['map']
